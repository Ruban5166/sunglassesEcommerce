...
const create_category_post = async (req, res) => {
    try {
        ...
        console.log('this is my catagory',category);
        if(!category){
             admin = false
             data = {
                categoryName: req.body.categoryName ? req.body.categoryName.trim() : '',
                categoryDescription: req.body.discription ? req.body.discription.trim() : '',
